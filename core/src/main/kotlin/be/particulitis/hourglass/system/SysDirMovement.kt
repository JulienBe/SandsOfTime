...
class SysDirMovement : IteratingSystem(Aspect.all(CompDir::class.java, CompDir::class.java, CompSpace::class.java, CompLayer::class.java)) {

    private lateinit var mSpace: ComponentMapper<CompSpace>
    private lateinit var mDir: ComponentMapper<CompDir>
    private lateinit var mPlayer: ComponentMapper<CompLayer>
